...
# ファイル名リストを受け取る
file_numbers = [13]  # ここに処理するファイルの番号をリストで指定
userank = 2
...
rank_file_names = [f"reλrankresult{num}.xlsx" for num in file_numbers]
...
# 全体のタイトルを追加
fig.suptitle("top2mode: Speed, F_lambda2, and Rank of F_lambda2", fontsize=14)
