...
# 全体のタイトルを追加
fig.suptitle("Speed, F_lambda2, and Rank of F_lambda2", fontsize=14)

# 注意書きを追加
plt.figtext(0.5, 0.01, "Red line = speed below 40 km/h.", ha="center", fontsize=10, color="gray")
